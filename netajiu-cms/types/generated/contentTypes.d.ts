...
export interface ApiCareerCareer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    neta: Schema.Attribute.Relation<'manyToOne', 'api::neta.neta'>;
    publishedAt: Schema.Attribute.DateTime;
    ref: Schema.Attribute.Text & Schema.Attribute.Required;
    since: Schema.Attribute.Date & Schema.Attribute.Required;
    till: Schema.Attribute.Date & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiHistoryHistory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    activity: Schema.Attribute.Text & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiNetaNeta extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    history: Schema.Attribute.Relation<'oneToMany', 'api::history.history'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::neta.neta'> &
      Schema.Attribute.Private;
    party: Schema.Attribute.Relation<'oneToOne', 'api::party.party'>;
    photo: Schema.Attribute.Media<'images' | 'files'> &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    social: Schema.Attribute.Relation<'oneToMany', 'api::social.social'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiPartyParty extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<['Left', 'Center', 'Right']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    foundedOn: Schema.Attribute.Date;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
